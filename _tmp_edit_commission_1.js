...
const file = 'src/app/electoral-commission-panel/import-students/components/CommissionStudentImportInteractive.tsx';

edit(file, (src) => {
  // 1. Replace mock processFile with shared parser
