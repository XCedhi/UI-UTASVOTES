...
interface ElectionAnalyticsInteractiveProps {
  electionId: string;
}

const ElectionAnalyticsInteractive = ({ electionId }: ElectionAnalyticsInteractiveProps) => {
                      ...
                      <div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            ...
                            <div className="w-full bg-background rounded-full h-2">
                              <div className="bg-warning h-2 rounded-full" style={{ width: '44%' }} />
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      {[
                        {
                          ...
                          description: 'Voting activity peaks between 9-11 AM, 15% higher than previous elections',
                        },
                        {
                          icon: 'UserGroupIcon',
                          color: 'text-primary',
                          title: 'High Youth Engagement',
                          description: 'Level 100 and 200 students showing 82% turnout, exceeding expectations',
                        },
                        {
                          icon: 'DevicePhoneMobileIcon',
                          color: 'text-warning',
                          title: 'Mobile Voting Dominance',
                          description: '68% of votes cast via mobile devices, up from 52% last year',
                        },
                        {
                          icon: 'ClockIcon',
                          color: 'text-error',
                          title: 'Evening Rush Expected',
                          description: 'Historical data suggests 30% of remaining votes will come in final 2 hours',
                        },
                      ].map((trend, index) => (
                        <div
                          key={index}
