...
const AdminElectionManagementInteractive = () => {
    ...
    const mockNotifications: Notification[] = [
      {
        ...
        isRead: false,
        actionUrl: '/admin-election-management',
      },
      {
        id: '2',
        type: 'system',
  ...
  const handleViewApplicationDetails = (id: string) => {
    router.push(`/admin-election-management/applications/${id}`);
  };

  const handleViewElectionAnalytics = (id: string) => {
    router.push(`/admin-election-management/elections/${id}/analytics`);
  };

  const handleManageElection = (id: string) => {
    router.push(`/admin-election-management/elections/${id}/manage`);
  };

  const handleCreateElection = () => {
    router.push('/admin-election-management/elections/create');
  };
...
export default AdminElectionManagementInteractive;
